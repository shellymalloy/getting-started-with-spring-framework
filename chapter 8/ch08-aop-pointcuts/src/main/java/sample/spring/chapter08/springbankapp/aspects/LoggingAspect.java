package sample.spring.chapter08.springbankapp.aspects;
...
import sample.spring.chapter08.springbankapp.dao.FixedDepositDao;
...
public class LoggingAspect {
	...
	@Pointcut(value = "execution(* sample.spring.chapter08.springbankapp.service.*Service.*(..))")
